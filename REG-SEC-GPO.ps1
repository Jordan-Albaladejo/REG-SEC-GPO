...
Write-Host " REG-SEC-GPO v1.0 - P.O.C."
...
Write-Host "
[1] Installer."
Write-Host "[2] Registry Audit Tool."
Write-Host "[3] Group Policy Objects Audit Tool."
Write-Host "[x] Exit."
...
$MenuChoice = Read-Host "Make your choice from the menu"
...
#########################################################################################################################################################################################################
########################################################################## - Ingest services - REG-SEC-GPO 1.0 - Installer - ############################################################################
#########################################################################################################################################################################################################
if ($MenuChoice1 -eq 'True') {
#########################################################################################################################################################################################################
########################################################################## - Terms and Conditions - #####################################################################################################
